!-----------------------------------------------------------------------
subroutine sub_HSMAC_fwd(ustg,vstg,pcnt)
!-----------------------------------------------------------------------
...
!!$omp private(ic,jc,kc,vol3)      &
!!$omp shared(imax,jmax,kmax,iblk) &
!!$omp shared(pcnt,vol2)           &
!!$omp reduction(+:psum,volm)
    do jc=1,jmax
    do ic=1,imax
